...
macro "sparfor"
{
    ...
    var codist = "3";
    {
        ...
        Dialog.addMessage("Enter minimal pixel distance for smoothing:");
    ...
    Array.getStatistics(xsum, min, max);
    xmax = max;
    Array.getStatistics(ysum, min, max);
    ymax = max;
    ...
    Plot.show()
        ...
        deltap_binp
        = Array.concat(deltap, PI); // used for both sparor and paror
