...
macro "Make 3 slices stack from stack of 2 [C]"
{
    ...
    // check stack
    if (nSlices > 2) {
        showMessage("Stack has more than 2 slices. Are you sure you want to add another slice?");
    }
    Stack.setSlice(2);
    run("Add Slice");
    Stack.setSlice(2);
